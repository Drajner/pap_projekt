...
INSERT INTO patients VALUES (01250356956, 'Kamil', 'Nowak', '2001-05-03', 'Cysts on the liver', 'M');
...
INSERT INTO accounts VALUES (1, 'admin', 'admin', 01212545653);
INSERT INTO accounts VALUES (2, 'arek', 'arek', 68042928832);
INSERT INTO accounts VALUES (3, 'jacek', 'kEcAj', 70010152275);
...
INSERT INTO accounts VALUES (11, 'V\\\\YD^3g8vh5tGm', 'c+}W}8k)Y/^U8q4]', 70040923184);
INSERT INTO accounts VALUES (12, '_S]+ygM2.]M=2k3]', 'z?;3Lvs@Sxx{LK!)', 58050153827);
...
UPDATE doctors SET spec_id = 1 WHERE pesel = 01212545653;
UPDATE doctors SET spec_id = 2 WHERE pesel = 70010152275;
UPDATE doctors SET spec_id = 3 WHERE pesel = 80071732176;
UPDATE doctors SET spec_id = 4 WHERE pesel = 95031266310;
UPDATE doctors SET spec_id = 4 WHERE pesel = 58041304863;
UPDATE doctors SET spec_id = 4 WHERE pesel = 97020371241;
UPDATE doctors SET spec_id = 5 WHERE pesel = 76111249041;
UPDATE doctors SET spec_id = 5 WHERE pesel = 78051972283;
UPDATE doctors SET spec_id = 5 WHERE pesel = 68042928832;
